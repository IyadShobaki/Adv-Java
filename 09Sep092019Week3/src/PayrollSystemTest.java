...
public class PayrollSystemTest {
	...
	public static void main(String[] args) {
		...
		SalariedEmployee salariedEmployee = new SalariedEmployee("Jhon", "Smith", "111-11-1111", 800.00);
		...
		System.out.printf("Employees processed polymorphismically:%n%n");
		
		// generically process each element in array employees
		for (Employee currentEmployee : employees) {
			System.out.println(currentEmployee); // invokes toStrong
