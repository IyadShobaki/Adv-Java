...
public class SliderFrame extends JFrame{
	...
	public SliderFrame() {
		...
		textArea.setText(String.format("%s: %.5f %s: %.5f %s: %.5f %s: %.5f",
		...
		circleMenuItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				System.out.println("The figure has changed to Circle");
		...
		squareMenuItem.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				System.out.println("The figure has changed to Square");
			}
		});
